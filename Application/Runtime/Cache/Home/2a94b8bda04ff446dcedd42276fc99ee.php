...
<html ng-app="indexApp" ng-controller="indexCtrl">
	...
	<body class="w1280" >
		...
		<!--moduel-->
		<!--title-->
		<div class="mod-1 channel louceng" id="bigfloor1">
			<div class="title">
				<h3>
					<a class="img" href="#">
						<strong>各地特产</strong>
		...
		<!--moduel2-->
		<!--title-->
		<div class="mod-2 channel louceng" id="bigfloor2">
			<div class="title">
				<h3>
					<a class="img " href="#">
		...
		<!--moduel3-->
		<!--title-->
		<div class="mod-2 channel louceng" id="bigfloor3">
			<div class="title">
				<h3>
					<a class="img " href="#">
		...
		<!--moduel4-->
		<!--title-->
		<div class="mod-3 channel louceng" id="bigfloor4">
			<div class="title">
				<h3>
					<a class="img" href="#">
		...
		<!--moduel5-->
		<!--title-->
		<div class="mod-3 channel louceng" id="bigfloor5">
			<div class="title">
				<h3>
					<a class="img " href="#">
		...
		<!--moduel5-->
		<!--title-->
		<div class="mod-3 channel louceng" id="bigfloor6">
			<div class="title">
				<h3>
					<a class="img " href="#">
		...
		<!--moduel4-->
		<!--title-->
		<div class="mod-3 channel louceng" id="bigfloor7">
			<div class="title">
				<h3>
					<a class="img " href="#">
		...
		<!--moduel3-->
		<!--title-->
		<div class="mod-2 channel louceng" id="bigfloor8">
			<div class="title">
				<h3>
					<a class="img " href="#">
		...
		<!--moduel6-->
		<div class="mod-6 channel louceng" id="bigfloor9">
			<div class="title">
				<h3>
					<a class="img " href="#">
		...
		<!--moduel6-->
		<div class="mod-6 channel louceng" id="bigfloor10">
			<div class="title">
				<h3>
					<a class="img " href="#">
		...
		<!--moduel6-->
		<div class="mod-6 channel louceng" id="bigfloor11">
			<div class="title">
				<h3>
					<a class="img " href="#">
		...
		<div id="floatTool" class="fix-bottom-10"  status="show">
			<a href="#bigfloor1"  class="f01" title="前往 1F 各地特产"><span>1F</span><label>各地特产</label></a>
			<a href="#bigfloor2" class="f02" title="前往 2F 手机数码"><span>2F</span><label>手机数码</label></a>
			<a href="#bigfloor3" class="f03" title="前往 3F 家用电器"><span>3F</span><label>家用电器</label></a>
			<a href="#bigfloor4" class="f04" title="前往 4F 美妆洗护"><span>4F</span><label>美妆洗护</label></a>
			<a href="#bigfloor5" class="f05" title="前往 5F 女装饰品"><span>5F</span><label>女装饰品</label></a>
			<a href="#bigfloor6" class="f06" title="前往 6F 魅力男装"><span>6F</span><label>魅力男装</label></a>
			<a href="#bigfloor7" class="f07" title="前往 7F 箱包鞋帽"><span>7F</span><label>箱包鞋帽</label></a>
			<a href="#bigfloor8" class="f08" title="前往 8F 母婴玩具"><span>8F</span><label>母婴玩具</label></a>
			<a href="#bigfloor9" class="f09" title="前往 9F 家居厨卫"><span>9F</span><label>家居厨卫</label></a>
			<a href="#bigfloor10" class="f10" title="前往 10F 运动汽配"><span>10F</span><label>运动汽配</label></a>
			<a href="#bigfloor11" class="f11" title="前往 11F 食品保健"><span>11F</span><label>食品保健</label></a>
