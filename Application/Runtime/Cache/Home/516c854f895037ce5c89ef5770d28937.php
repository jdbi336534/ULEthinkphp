	...
	<body class="w1280">
		...
		<div id="register">
			<div class="register-box">
				<div class="reg-title">
					<div class="title-txt">新用户注册</div>
				</div>
				<form action="" method="post">
					<div class="reg-main">
						<div class="iTem reg-phone">
							<label>手机号码</label>
							<div class="item-input">
								<input type="text" name="userMobile" id="userMobile" data-tip="请输入您的手机号" value="" maxlength="13" placeholder="请输入您的手机号" />
							</div>
							<span class="tip"></span>
						</div>
						<div class="iTem reg-imgCode">
							<label>验证码</label>
							<div class="wrapcode">
								<div class="wrapcode-box">
									<div class="imgCode">
										<div class="item-input">
						...
						<div class="iTem reg-userpasswd">
							<label>设置密码</label>
							<div class="item-input">
								<input type="password" name="userMobile" id="password" data-tip="请设置6-20位字符的密码" value="" maxlength="20" placeholder="请设置6-20位字符的密码" />
							</div>
							<span class="tip"></span>
						</div>
						<div class="iTem reg-repeatpasswd">
							<label>确认密码</label>
							<div class="item-input">
								<input type="password" name="userMobile" id="repeatpasswd" data-tip="再次输入密码" value="" maxlength="20" placeholder="再次输入密码" />
							</div>
							<span class="tip"></span>
						</div>
						<div class="iTem reg-prot">
							<label></label>
							<div class="prot-main">
								<i id="agreei"></i>
								<span for="agreePrivacy" class="secondary">
                        我接受 <a class="blueLink" href="#" target="_blank">《邮乐用户协议》</a> 及其相关的条款和条件
                    </span>
							</div>
						</div>
						<div class="iTem reg-btn">
							<label></label>
							<div class="btn-main">
								<input type="hidden" id="regtype" name="regtype" value="mobile">
								<a class="regMobBtn disable" href="javascript:void(0);"></a>
							</div>
						</div>
